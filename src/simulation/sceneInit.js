// ═══════════════════════════════════════════════════════════════
// src/simulation/sceneInit.js — Entry Point (Vite/React version)
// Adaptasi dari js/main.js: sama persis, hanya:
//   1. Import path three/addons → three/examples/jsm (npm package)
//   2. Wrapped dalam exported function startScene(container)
//      agar bisa dipanggil dari React useEffect setelah DOM siap
// ═══════════════════════════════════════════════════════════════
...
/**
 * Inisialisasi seluruh Three.js scene dan masukkan renderer ke dalam
 * container element yang diberikan oleh React via useRef.
 *
 * @param {HTMLElement} container - div#canvas-container dari App.jsx
 * @returns {Function} cleanup — dipanggil saat komponen React di-unmount
 */
export function startScene(container) {
  ...
  // ── CLEANUP (dipanggil saat React unmount) ────────────────────
